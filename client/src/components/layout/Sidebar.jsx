                ...
                <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
                    {showAdminLink && (
                        <>
                            <Link
                                to="/admin"
                                className="flex items-center gap-3 px-4 py-3 mb-2 rounded-lg bg-linear-to-r from-blue-600 to-blue-700 text-white font-medium hover:from-blue-700 hover:to-blue-800 transition-all"
                            >
                                <ShieldCheck size={20} />
                                Admin Panel
                            </Link>
                    ...
                    <SidebarLink to="/dashboard/environmental" label="Environment & Weather" icon={<CloudSun size={20} />} />
